...
urlpatterns = [
    ...
    path('remittances/<int:pk>/transfer/', views.transfer_remittance, name='transfer_remittance'),
    path('remittances/transfer-all/', views.transfer_all_remittances, name='transfer_all_remittances'),
