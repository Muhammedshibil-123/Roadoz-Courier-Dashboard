  ...
  const filteredOrders = useMemo(() => {
    ...
    if (searchOrderId.trim()) {
      ...
      result = result.filter((o) =>
        ids.some(
          (id) =>
            o.tracking_id?.toLowerCase().includes(id) ||
            String(o.id).includes(id),
        ),
      );
    }
...
export function OrderFilterBar({
  ...
  useEffect(() => {
    api
      .get("/api/orders/stats/", { skipLoading: true })
