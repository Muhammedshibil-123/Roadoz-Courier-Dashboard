...
const PickupAddress = () => {
  ...
  const fetchAddresses = async () => {
    try {
      const res = await api.get("/api/auth/settings/pickup-address/", {
        skipLoading: true,
      });
  ...
  const handleSave = async () => {
    ...
    try {
      if (editingId) {
        await api.put(
          `/api/auth/settings/pickup-address/${editingId}/`,
          payload,
        );
            ...
            <table className="w-full min-w-[850px]">
              ...
              <tbody>
                {addresses.map((addr) => (
                  ...
                  >
                    <td className="p-4 text-center text-sm font-bold text-[var(--color-text-primary)]">
                      {addr.id}
                    </td>
                    ...
                    <td className="p-4 text-center text-sm text-[var(--color-text-primary)]">
                      {addr.pincode}
                    </td>
                    <td className="p-4 text-center">
                      <button
                    ...
                    <td className="p-4 text-center text-sm text-[var(--color-text-secondary)]">
                      {addr.warehouse_name || "—"}
                    </td>
                    <td className="p-4 text-center text-xs text-[var(--color-text-secondary)] max-w-[180px] whitespace-pre-line">
                      {addr.address}
                    </td>
                    <td className="p-4 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateForm("warehouse_name", e.target.value)
                    }
                  />
                </div>
